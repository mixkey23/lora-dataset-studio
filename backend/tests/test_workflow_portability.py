...
DECLARED_THIRD_PARTY_NODES = {
    ...
    # Qwen Edit / Qwen Multi-angle. Gated by qwen_edit_helper.qwen_edit_missing_nodes()
    # / qwen_edit_helper.qwen_edit_nsfw_missing_nodes() / qwen_multiangle_helper.
    # qwen_ma_missing_nodes() — exact pack/URL unknown, same (None, None) convention
    # those preflights already use.
    'CFGNorm': 'unknown (Qwen Edit / Multi-angle Kontext-lineage sampling pack)',
    'ModelSamplingAuraFlow': 'unknown (Qwen Edit / Multi-angle Kontext-lineage sampling pack)',
    'QwenEditAdaptiveLongestEdge': 'ComfyUI-QwenEditUtils (lrzjason)',
    'QwenEditConfigPreparer': 'ComfyUI-QwenEditUtils (lrzjason)',
    'TextEncodeQwenImageEditPlusCustom_lrzjason': 'ComfyUI-QwenEditUtils (lrzjason)',
    'TextEncodeQwenImageEditPlus': 'unknown (Qwen Edit NSFW / Multi-angle Kontext-lineage pack)',
    'FluxKontextImageScale': 'unknown (Qwen Multi-angle Kontext-lineage pack)',
    'FluxKontextMultiReferenceLatentMethod': 'unknown (Qwen Multi-angle Kontext-lineage pack)',
}
