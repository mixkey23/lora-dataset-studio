...
export const ENGINES = ['klein', 'krea', 'qwen_edit', 'nanobanana', 'chatgpt', 'openrouter'];
 ...
 *  face_dataset_service.LOCAL_ENGINES (+ qwen_edit, folded in there the same
 *  way — see regenerate_image's own local shadow) — derive from this, never
 *  re-list it. */
export const LOCAL_ENGINES = ['klein', 'krea', 'qwen_edit'];
...
export const ENGINE_ACCENTS = {
  ...
  // Teal: the third LOCAL engine, distinct from Klein's indigo and Krea's violet
  // (and from green, which already means "kept / free" everywhere else).
  qwen_edit: {
...
export const ENGINE_RATES = { klein: 0, krea: 0, qwen_edit: 0, nanobanana: 0.15, chatgpt: 0.17, openrouter: 0.15 };
