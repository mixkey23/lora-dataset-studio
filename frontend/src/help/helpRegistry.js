...
const TOPICS = [
  ...
  setting('qwen_edit', 'engines', 'qwen-edit', 'Qwen Edit tuning',
    ['qwen', 'qwen edit', 'generate variations', 'local engine', 'lora', 'lightning',
     'consistency', 'qwen-image-edit', '2511', 'render style', 'non-photoreal']),
